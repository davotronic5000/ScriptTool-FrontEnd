  ...
  return (
    <Box mb={2}>
      ...
      <FormControl>
        ...
        />
        <FormHelperText>
          This colour will be used to create the side bar and back of the
          script. Due to the way these are created, the actual colour appearance
          may vary.
        </FormHelperText>
      </FormControl>
      <FormControl>
        <FormLabel>Would you like us to colourise any custom images?</FormLabel>
        <Checkbox
          isChecked={script.colourise}
          onChange={(event) =>
            dispatch({
              type: "update-boolean-value",
              data: { key: "colourise", value: event.target.checked },
            })
          }
        />
      </FormControl>
